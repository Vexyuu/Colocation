 ...
 */
final class Version20260531151143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN password_reset_token_expires_at DATETIME DEFAULT NULL');
    }
